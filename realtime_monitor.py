...
def getRealtime_v5(): 
    ...
    def animate(i):
        ...
        ax[0,1].clear()
        ax1_twin.clear()
        sns.lineplot(y=merged['ratio_wma_long_ratio_wma_short_crossover'], x=merged['date'], ax=ax1_twin, color='green', label='crossover')
        # ax1_twin.clear()
        ...
        ax[0,1].axhline(y=0, color='grey', linestyle='-', alpha=0.3)
        # show legend 
